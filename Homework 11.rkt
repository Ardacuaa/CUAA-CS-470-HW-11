...
;Variable Scope / Environment Section

;() | ((varname var_value)....)
(define env '((a 5) (b 7) (c 9)))
...
;Extended Environment Section = ((a 1) (b 2) (c 5)
...
;(app-exp (func-exp (params (identifier1, identifier2, identifer3 ...)) (body-exp)) ((neo-exp1 neo-exp2 neo-exp3 ...))
(define sample-code '(call (function () (ask (bool > c b) (math - c b) (math + c b))) (c)))
